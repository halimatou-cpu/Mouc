...
<div class="verticalement">
    <fieldset>
        <legend align="center">Ajout d'un type d'identification</legend>
...
?>
                    <tr>
                        <td><a href="#" data-toggle="modal" data-target="#AjoutId" class="btn btn-success"><span
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer" align="center">
                <form method="post" action="traitement_ajout_id.php">
                    <table>
                        <tr>
                            <td><label for="inputLogin" class="control-label">Nouveau moyen d'identification</label>
                            </td>
                            <td><input type="text" name="AjoutId" class="form-control" required value="" maxlength="40">
                            </td>
                        </tr>
                    </table>
