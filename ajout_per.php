    ...
    <fieldset>
        ...
        <div class="table-reponsive">
            <table class="table table-hover">
                ...
                <tbody>
                    <form action="traitement_tique_ouvert.php" method="post">
                        <?php
						foreach($res as $row)
						{
?>
...
?>
                        <tr>
                            <td><a href="#" data-toggle="modal" data-target="#AjoutPer" class="btn btn-success"><span
                                        class="glyphicon glyphicon-plus"></span> Ajouter une personne</a></td>
                        </tr>
                    </form>
                </tbody>
            </table>
                ...
                <form method="post" action="traitement_ajout_per.php">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="nom" class="form-control" id="nom" placeholder="nom" required
                                    value="" maxlength="24"></td>
                        </tr>
                        <tr>
                            <td><label for="inputPrenom" class="control-label">Prénom</label></td>
                            <td><input type="text" name="prenom" class="form-control" id="prenom" placeholder="prénom"
                                    required value="" maxlength="25"></td>
                        </tr>
                        <tr>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="defaultUnchecked"
                                    onclick="CheckDisabled('defaultUnchecked');">
                                <label class="custom-control-label" for="defaultUnchecked">Remplir les moyens
                                    d'identification plus tard (nom et prénom par défaut)</label>
                            </div>
...
?>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="valeur" class="form-control" id="valeur" placeholder="valeur"
                                    required value="" maxlength="50"></td>
                        </tr>
                    </table>
