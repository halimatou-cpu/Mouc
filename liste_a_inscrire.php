<title>Liste des personnes à inscrire à l'évènement</title>
<?php
	include("session.php");
	if(!isset($_GET["eid"]))
	{
...
<div class="verticalement">
    <fieldset>
        <legend align="center">Liste des personnes à inscrire à l'évènement</legend>
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    <form action="traitement_a_inscrire.php" method="post">
                        <?php
								foreach($st as $row)
								{
?>
