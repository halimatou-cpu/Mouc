...
<div class="verticalement">
    <fieldset>
        <legend align="center">Modification des identifiants d'une personne</legend>
...
?>
                    <tr class="active">
                        ...
                        <td><a href="#" id="<?php echo $row['pid'].' '.$row['tid']; ?>" data-toggle="modal"
                                data-target="#ModIdPer"
                                onclick="GetPidTidValeur('<?php echo htmlspecialchars(addslashes($row['pid'])); ?>','<?php echo htmlspecialchars(addslashes($row['tid'])); ?>','<?php echo htmlspecialchars(addslashes($row['valeur'])); ?>');"><span
